...
import { BackArrowIcon, CreateBaseDefinitionForm } from '../components';

export const CreateBaseDefinition: FC = () => {
    ...
    <div className="mx-auto h-screen">
      <div className="shadow-[0_2px_4px_rgba(0,0,0,0.075)] px-4 py-2 flex justify-between items-center">
        <div className="flex flex-row space-x-2 p-2 items-center">
          ...
          <p>Create Base Property Definition</p>
        </div>
      </div>
      <CreateBaseDefinitionForm collectionId={collectionId} />
    </div>
  );
};
